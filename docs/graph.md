...
| Строка отчёта: лейбл, mapping, одна формула строки, серии кэша по осям, статус значения, scale factor, нормализованные значения, position/aggregation | `context.json` / `context.md` (schema `1.11.0`, оси в `axes`) |
